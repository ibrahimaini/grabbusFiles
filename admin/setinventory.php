			...
			<div id="panel" class="radius">
				...
				<div id="content" class="clearfix">
					...
					<table cellpadding="1" cellspacing="1" id="resultTable">
						<thead>
							<tr>
								<th  style="border-left: 1px solid #C1DAD7"> Departure Date </th>
						        <th> Return Date </th>
								<th> Bus Type </th>
								<th> Route </th>
								<th> Seat Number </th>
							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td style="border-left: 1px solid #C1DAD7;">'.$row['departure_date'].'</td>';
									echo '<td><div align="right">'.$row['return_date'].'</div></td>';
